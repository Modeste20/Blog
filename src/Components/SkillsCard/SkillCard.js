...
const SkillCard = ({title,icon,children}) => {
  ...
  return (
    <article className={"col-12 mx-0 p-0 mx-auto mx-md-0  col-sm-6 col-md-6 col-lg-4"}>
        <div className="article-skill px-3 py-4 mx-3 mb-3 mb-md-4">
...
export const SKILLS = [
    {   
        ...
        children:(
            <p>
                Mes connaissances en <strong><abbr title='HyperText Markup language'>HTML</abbr></strong>, <strong><abbr title='Cascade Style Sheets'>CSS</abbr></strong> et
    ...
    },
    {
        ...
        children:(
            <p>
                Le duo <strong>Git et Github</strong> simplifie la collaboration avec d'autres développeurs sur un projet.
                Github permet  d'héberger le code d'un projet sur internet afin qu'il ne soit pas perdu en cas de panne de l'ordinateur du développeur
                par exemple.
            </p>
        )
    },
        ...
        children:(
            <p>
                La maîtrise des outils de conception, des logiciels de création de wireframes et de maquettes tels que Figma,
                 la compréhension des principes du design UI sont indispensables en vue de concevoir des interfaces utilisateurs attrayantes.
